...
import com.thesis.historya.level8.Barrio8Terrain1Activity;

@SuppressLint("NewApi")
public class Barrio7Terrain3Activity extends BaseGameActivity {
    ...
    private static final String LEVEL = "LEVEL7";
    ...
    protected void onCreate(Bundle pSavedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("fromB7Terrain2", false)) {
            heroX = 10;
            getIntent().putExtra("fromB7Terrain2", false);
        } else {
            heroX = gameUtils.getX();
        }
        heroY = gameUtils.getY();
        playerDirection = direction.DOWN;
        riddlePopUp = new AlertDialog.Builder(Barrio7Terrain3Activity.this);
        ...
        gameUtils.setAnswer(GameUtils.Riddles.RIDDLE7.toString(), "Classics");
        // riddle7 = getBaseContext().getString(R.string.riddle7);
                ...
                new IAnalogOnScreenControlListener() {
                    ...
                    public void onControlChange(BaseOnScreenControl pBaseOnScreenControl, float pValueX, float pValueY) {
                        ...
                        if (hero.getX() <= -10) {
                            ...
                            Intent bTerrain2Intent = new Intent(Barrio7Terrain3Activity.this, Barrio7Terrain2Activity.class);
                            ...
                            Barrio7Terrain3Activity.this.finish();
                        }
            ...
            public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
                ...
                case TouchEvent.ACTION_DOWN:
                    if (hero.collidesWith(hermit)) {
                        ...
                        for (String answers : Barrio7Terrain3Activity.this.getResources().getStringArray(R.array.answers)) {
                            riddleAnswers.add(answers);
                        }
                        List<String> riddles = new ArrayList<String>();
                        for (String riddle : Barrio7Terrain3Activity.this.getResources().getStringArray(R.array.riddles)) {
                            riddles.add(riddle);
                        }
                        riddle7 = riddles.get(randomNumber);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (!gameUtils.hasQuestionBeenAnswered(GameUtils.Riddles.RIDDLE7.toString())) {
                                    new AlertDialog.Builder(Barrio7Terrain3Activity.this).setTitle("Riddle #7").setMessage(riddle7)
                                            .setView(etRiddle).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialog, int which) {
                                                    ...
                                                    if (isAnswerCorrect) {
                                                        Toast.makeText(getBaseContext(), "Correct! Now head to the east for your next quest.",
                                                                Toast.LENGTH_LONG).show();
                                                        heroScore += 100;
                                                        right.detachSelf();
                                                        gameUtils.setLevelPassed(LEVEL);
                                                        hermit.registerEntityModifier(new FadeInModifier(4f));
                                                        gameUtils.setQuestionAnswered(GameUtils.Riddles.RIDDLE7.toString(), true);
                                                    } else {
                                                        Toast.makeText(getBaseContext(), "Come back next time when you know the answer...", Toast.LENGTH_LONG).show();
                                                        gameUtils.setQuestionAnswered(GameUtils.Riddles.RIDDLE7.toString(), false);
                                                    }
                                                }
                                            }).show();
                                } else {
        ...
        scene.registerUpdateHandler(new IUpdateHandler() {
            ...
            public void onUpdate(float pSecondsElapsed) {
                ...
                if (hero.collidesWith(hermit) && playerDirection.equals(direction.RIGHT)) {
                    ...
                    dbHelper.updateScore(sqlDb, dbHelper.TABLE_NAME1, gameUtils.retrieveUsername(), heroScore);
                    Intent b8Terrain1Intent = new Intent(Barrio7Terrain3Activity.this, Barrio8Terrain1Activity.class);
                    b8Terrain1Intent.putExtra("heroFromT3X", hero.getX());
                    b8Terrain1Intent.putExtra("heroFromT3Y", hero.getY());
                    b8Terrain1Intent.putExtra("fromB7Terrain3", true);
                    Barrio7Terrain3Activity.this.startActivity(b8Terrain1Intent);
                    Barrio7Terrain3Activity.this.finish();
                }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            AlertDialog.Builder pauseAlert = new AlertDialog.Builder(Barrio7Terrain3Activity.this).setTitle("Game Paused").setItems(items, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    case 1:
                        dbHelper.updateScore(sqlDb, dbHelper.TABLE_NAME1, gameUtils.retrieveUsername(), heroScore);
                        Barrio7Terrain3Activity.this.startActivity(new Intent(Barrio7Terrain3Activity.this, MainMenuActivity.class));
                        finish();
                        break;
                    }
                }
