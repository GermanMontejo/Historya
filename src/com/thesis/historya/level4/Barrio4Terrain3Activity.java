...
import com.thesis.historya.level5.Barrio5Terrain1Activity;

@SuppressLint("NewApi")
public class Barrio4Terrain3Activity extends BaseGameActivity {
    ...
    protected void onCreate(Bundle pSavedInstanceState) {
        ...
        riddlePopUp = new AlertDialog.Builder(Barrio4Terrain3Activity.this);
        ...
        gameUtils.setAnswer(GameUtils.Riddles.RIDDLE4.toString(), "Mt. Buntis");
        // riddle4 = getBaseContext().getString(R.string.riddle4);
    ...
    public Scene onLoadScene() {
                ...
                new IAnalogOnScreenControlListener() {
                    ...
                    public void onControlChange(BaseOnScreenControl pBaseOnScreenControl, float pValueX, float pValueY) {
                        ...
                        if (hero.getX() <= -10) {
                            ...
                            Intent b4Terrain2Intent = new Intent(Barrio4Terrain3Activity.this, Barrio4Terrain2Activity.class);
                            b4Terrain2Intent.putExtra("heroFromT3X", hero.getX());
                            b4Terrain2Intent.putExtra("heroFromT3Y", hero.getY());
                            b4Terrain2Intent.putExtra("fromB4Terrain3", true);
                            startActivity(b4Terrain2Intent);
                            Barrio4Terrain3Activity.this.finish();
                        } else if (hero.getX() >= CAMERA_WIDTH && gameUtils.getLevelPassed(LEVEL)) {
                            dbHelper.updateScore(sqlDb, dbHelper.TABLE_NAME1, gameUtils.retrieveUsername(), heroScore);
                            Intent b5Terrain1Intent = new Intent(Barrio4Terrain3Activity.this, Barrio5Terrain1Activity.class);
                            b5Terrain1Intent.putExtra("heroFromT3X", hero.getX());
                            b5Terrain1Intent.putExtra("heroFromT3Y", hero.getY());
                            b5Terrain1Intent.putExtra("fromB4Terrain3", true);
                            Barrio4Terrain3Activity.this.startActivity(b5Terrain1Intent);
                            Barrio4Terrain3Activity.this.finish();
                        }
            ...
            public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
                ...
                case TouchEvent.ACTION_DOWN:
                    if (hero.collidesWith(hermit)) {
                        ...
                        for (String answers : Barrio4Terrain3Activity.this.getResources().getStringArray(R.array.answers)) {
                            riddleAnswers.add(answers);
                        }
                        List<String> riddles = new ArrayList<String>();
                        for (String riddle : Barrio4Terrain3Activity.this.getResources().getStringArray(R.array.riddles)) {
                            riddles.add(riddle);
                        }
                        riddle4 = riddles.get(randomNumber);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Toast.makeText(getBaseContext(), "It's too late... No matter how many spells I invoke, it's not enough to save this land. Death already marked this land as his.", Toast.LENGTH_LONG).show();
                                Toast.makeText(getBaseContext(), "Say lad, do you love riddles? Only the wise can move to the next place...", Toast.LENGTH_LONG).show();
                                Handler handler = new Handler();
                                handler.postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        if (!gameUtils.hasQuestionBeenAnswered(GameUtils.Riddles.RIDDLE4.toString())) {
                                            new AlertDialog.Builder(Barrio4Terrain3Activity.this).setTitle("Riddle #4").setMessage(riddle4)
                                                    .setView(etRiddle).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                        ...
                                                        public void onClick(DialogInterface dialog, int which) {
                                                            ...
                                                            if (isAnswerCorrect) {
                                                                Toast.makeText(getBaseContext(), "You got the correct answer young lad! You're one of the wisest men I've encountered.",
                                                                        Toast.LENGTH_LONG).show();
                                                                heroScore += 100;
                                                                gameUtils.setLevelPassed(LEVEL);
                                                                hermit.registerEntityModifier(new FadeInModifier(4f));
                                                                gameUtils.setQuestionAnswered(GameUtils.Riddles.RIDDLE4.toString(), true);
                                                            } else {
                                                                Toast.makeText(getBaseContext(), "Come back next time when you know the answer...", Toast.LENGTH_LONG).show();
                                                                gameUtils.setQuestionAnswered(GameUtils.Riddles.RIDDLE4.toString(), false);
                                                            }
                                                        }
                                                    }).show();
                                        } else {
        ...
        scene.registerUpdateHandler(new IUpdateHandler() {
            ...
            public void onUpdate(float pSecondsElapsed) {
                ...
                } else if (hero.collidesWith(right) && playerDirection.equals(direction.RIGHT) && !gameUtils.hasQuestionBeenAnswered(GameUtils.Riddles.RIDDLE4.toString())) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            AlertDialog.Builder pauseAlert = new AlertDialog.Builder(Barrio4Terrain3Activity.this).setTitle("Game Paused").setItems(items, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    case 1:
                        dbHelper.updateScore(sqlDb, dbHelper.TABLE_NAME1, gameUtils.retrieveUsername(), heroScore);
                        Barrio4Terrain3Activity.this.startActivity(new Intent(Barrio4Terrain3Activity.this, MainMenuActivity.class));
                        finish();
                        break;
                    }
                }
