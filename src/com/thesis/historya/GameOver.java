...
public class GameOver extends BaseGameActivity {
    ...
    protected static final int MENU_QUIT = MENU_gameOver + 1;
    ...
    private Font font;
    private Text gameOverText, gameOverContent, howToPlayText, howToPlayContent;
 ...
 new RatioResolutionPolicy(CAMERA_WIDTH, CAMERA_HEIGHT), camera).setNeedsMusic(true).setNeedsSound(true);
    ...
    public Scene onLoadScene() {
        ...
        gameOverText = new Text(CAMERA_WIDTH / 4 - 5, CAMERA_HEIGHT / 4, font, getResources().getString(R.string.game_over));
        gameOverContent = new Text(CAMERA_WIDTH / 4 - 30, CAMERA_HEIGHT / 4 + 20, font, getResources().getString(R.string.game_over_content));
        ...
        mainScene.getLastChild().attachChild(gameOverText);
        mainScene.getLastChild().attachChild(gameOverContent);
        return mainScene;
    }
