...
import com.thesis.historya.level4.Barrio4Terrain2Activity;
import com.thesis.historya.level6.Barrio6Terrain1Activity;

@SuppressLint("NewApi")
public class Barrio5Terrain4Activity extends BaseGameActivity {
    ...
    protected void onCreate(Bundle pSavedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("fromB5Terrain3", false)) {
            heroX = 10;
            getIntent().putExtra("fromB5Terrain3", false);
        }
        heroY = gameUtils.getY();
        playerDirection = direction.DOWN;
        riddlePopUp = new AlertDialog.Builder(Barrio5Terrain4Activity.this);
        ...
        gameUtils.setAnswer(GameUtils.Riddles.RIDDLE5.toString(), "Negrito");
        // riddle5 = getBaseContext().getString(R.string.riddle5);
    ...
    public Scene onLoadScene() {
                ...
                new IAnalogOnScreenControlListener() {
                    ...
                    public void onControlChange(BaseOnScreenControl pBaseOnScreenControl, float pValueX, float pValueY) {
                        ...
                        if (hero.getX() <= -10) {
                            ...
                            Intent b5Terrain3Intent = new Intent(Barrio5Terrain4Activity.this, Barrio4Terrain2Activity.class);
                            b5Terrain3Intent.putExtra("heroFromT4X", hero.getX());
                            b5Terrain3Intent.putExtra("heroFromT4Y", hero.getY());
                            b5Terrain3Intent.putExtra("fromB5Terrain4", true);
                            startActivity(b5Terrain3Intent);
                            Barrio5Terrain4Activity.this.finish();
                        } else if (hero.getX() >= CAMERA_WIDTH && gameUtils.getLevelPassed(LEVEL)) {
                            dbHelper.updateScore(sqlDb, dbHelper.TABLE_NAME1, gameUtils.retrieveUsername(), heroScore);
                            Intent b6Terrain1Intent = new Intent(Barrio5Terrain4Activity.this, Barrio6Terrain1Activity.class);
                            b6Terrain1Intent.putExtra("heroFromT4X", hero.getX());
                            b6Terrain1Intent.putExtra("heroFromT4Y", hero.getY());
                            b6Terrain1Intent.putExtra("fromB5Terrain4", true);
                            Barrio5Terrain4Activity.this.startActivity(b6Terrain1Intent);
                            Barrio5Terrain4Activity.this.finish();
                        }
            ...
            public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
                ...
                case TouchEvent.ACTION_DOWN:
                    if (hero.collidesWith(hermit)) {
                        ...
                        for (String answers : Barrio5Terrain4Activity.this.getResources().getStringArray(R.array.answers)) {
                            riddleAnswers.add(answers);
                        }
                        List<String> riddles = new ArrayList<String>();
                        for (String riddle : Barrio5Terrain4Activity.this.getResources().getStringArray(R.array.riddles)) {
                            riddles.add(riddle);
                        }
                        riddle5 = riddles.get(randomNumber);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Toast.makeText(getBaseContext(), "I will only allow you to proceed once you answer this question", Toast.LENGTH_LONG).show();
                                Handler handler = new Handler();
                                handler.postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        try {
                                            if (!gameUtils.hasQuestionBeenAnswered(GameUtils.Riddles.RIDDLE5.toString())) {
                                                new AlertDialog.Builder(Barrio5Terrain4Activity.this).setTitle("Riddle #5").setMessage(riddle5)
                                                        .setView(etRiddle).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                            ...
                                                            public void onClick(DialogInterface dialog, int which) {
                                                                ...
                                                                if (isAnswerCorrect) {
                                                                    ...
                                                                    gameUtils.setQuestionAnswered(GameUtils.Riddles.RIDDLE5.toString(), true);
                                                                } else {
                                                                    Toast.makeText(getBaseContext(), "Come back next time when you know the answer...", Toast.LENGTH_LONG).show();
                                                                    gameUtils.setQuestionAnswered(GameUtils.Riddles.RIDDLE5.toString(), false);
                                                                }
                                                            }
                                                        }).show();
                                            } else {
        ...
        scene.registerUpdateHandler(new IUpdateHandler() {
            ...
            public void onUpdate(float pSecondsElapsed) {
                ...
                } else if (hero.collidesWith(right) && playerDirection.equals(direction.RIGHT) && !gameUtils.hasQuestionBeenAnswered(GameUtils.Riddles.RIDDLE5.toString())) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            AlertDialog.Builder pauseAlert = new AlertDialog.Builder(Barrio5Terrain4Activity.this).setTitle("Game Paused").setItems(items, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    case 1:
                        dbHelper.updateScore(sqlDb, dbHelper.TABLE_NAME1, gameUtils.retrieveUsername(), heroScore);
                        Barrio5Terrain4Activity.this.startActivity(new Intent(Barrio5Terrain4Activity.this, MainMenuActivity.class));
                        finish();
                        break;
                    }
                }
