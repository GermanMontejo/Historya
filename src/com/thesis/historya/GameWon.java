...
public class GameWon extends BaseGameActivity {
    // CONTSTANTS
    private static final int CAMERA_WIDTH = 480;
    private static final int CAMERA_HEIGHT = 320;

    protected static final int MENU_gameWon = 0;
    protected static final int MENU_QUIT = MENU_gameWon + 1;
    ...
    private Font font;
    private Text gameWonText, gameWonContent, howToPlayText, howToPlayContent;
 ...
 new RatioResolutionPolicy(CAMERA_WIDTH, CAMERA_HEIGHT), camera).setNeedsMusic(true).setNeedsSound(true);
    ...
    public Scene onLoadScene() {
        ...
        gameWonText = new Text(CAMERA_WIDTH / 4 - 5, CAMERA_HEIGHT / 4, font, getResources().getString(R.string.game_won));
        gameWonContent = new Text(CAMERA_WIDTH / 4 - 30, CAMERA_HEIGHT / 4 + 20, font, getResources().getString(R.string.game_won_content));
        ...
        mainScene.getLastChild().attachChild(gameWonText);
        mainScene.getLastChild().attachChild(gameWonContent);
        return mainScene;
    }
