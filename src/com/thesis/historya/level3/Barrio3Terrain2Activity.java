...
public class Barrio3Terrain2Activity extends BaseGameActivity {
    ...
    protected void onCreate(Bundle pSavedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("fromB3Terrain1", false)) {
            heroX = 10;
            getIntent().putExtra("fromB3Terrain1", false);
        } else if (getIntent().getBooleanExtra("fromB3Terrain3", false)) {
    ...
    public void onLoadResources() {
        ...
        grassTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(grassTexture, this, "grass_tile10.png", 0, 0);
    ...
    public Scene onLoadScene() {
        ...
        if (!gameUtils.hasQuestionBeenAnswered(GameUtils.Riddles.SECRET_CODE.toString())) {
        ...
        final DigitalOnScreenControl digitalOnScreenControl = new DigitalOnScreenControl(0, CAMERA_HEIGHT - baseTextureRegion.getHeight(), camera, baseTextureRegion, knobTextureRegion, .1f,
                new IAnalogOnScreenControlListener() {
                    ...
                    public void onControlChange(BaseOnScreenControl pBaseOnScreenControl, float pValueX, float pValueY) {
                        ...
                        if (hero.getX() <= -10) {
                            Intent b3Terrain1Intent = new Intent(Barrio3Terrain2Activity.this, Barrio3Terrain1Activity.class);
                            ...
                            Barrio3Terrain2Activity.this.finish();
                        } else if (hero.getX() >= CAMERA_WIDTH) {
                            Intent b3Terrain3Intent = new Intent(Barrio3Terrain2Activity.this, Barrio3Terrain3Activity.class);
            ...
            public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
                ...
                case TouchEvent.ACTION_DOWN:
                    if (hero.collidesWith(rock1)) {
                        ...
                        Toast.makeText(getBaseContext(), "That weird guy over there won't let you pass unless you know the 'secret code'. Pssh. What a bunch of losers.", Toast.LENGTH_LONG).show();
                        Toast.makeText(getBaseContext(), "You wanna know the secret code? It's Supercalifragilisticexpialidocious!", Toast.LENGTH_LONG).show();
                        Toast.makeText(getBaseContext(), "Haha! Got you! I'm just messing around with you.", Toast.LENGTH_LONG).show();
                    } else if (hero.collidesWith(hermit1)) {
                        Toast.makeText(getBaseContext(), "The night of the blood moon is near. Only those who know the secret code are allowed to enter beyond the barrier.", Toast.LENGTH_LONG).show();
                        Toast.makeText(getBaseContext(), "I am Arcadius, master of barrier magic. Tell me, do you know the secret code?.", Toast.LENGTH_LONG).show();
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                if (!gameUtils.hasQuestionBeenAnswered(GameUtils.Riddles.SECRET_CODE.toString())) {
                                    new AlertDialog.Builder(Barrio3Terrain2Activity.this).setTitle("Secret Code").setMessage(getResources().getString(R.string.secret_code)).setView(etAnswer)
                                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {

                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            String answer = etAnswer.getText().toString();
                                            boolean isAnswerCorrect = gameUtils.compareAnswer(GameUtils.Riddles.SECRET_CODE, answer);
                                            if (isAnswerCorrect) {
                                                Toast.makeText(getBaseContext(), "You are free to pass...", Toast.LENGTH_LONG).show();
                                                hermit1.registerEntityModifier(new FadeInModifier(4f));
                                                gameUtils.setQuestionAnswered(GameUtils.Riddles.SECRET_CODE.toString(), true);
                                                barrier.reset();
                                                barrier.detachSelf();
                                            } else {
                                                Toast.makeText(getBaseContext(), "Only the ones entrusted with the secret code can pass through...", Toast.LENGTH_LONG).show();
                                                gameUtils.setQuestionAnswered(GameUtils.Riddles.SECRET_CODE.toString(), false);
                                            }
                                        }
                                    }).show();
                                }
        ...
        scene.registerUpdateHandler(new IUpdateHandler() {
            ...
            public void onUpdate(float pSecondsElapsed) {
                ...
                } else if (hero.collidesWith(barrier) && !gameUtils.hasQuestionBeenAnswered(GameUtils.Riddles.SECRET_CODE.toString())) {
                    if (playerDirection.equals(direction.RIGHT)) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            AlertDialog.Builder pauseAlert = new AlertDialog.Builder(Barrio3Terrain2Activity.this).setTitle("Game Paused").setItems(items, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        Barrio3Terrain2Activity.this.startActivity(new Intent(Barrio3Terrain2Activity.this, MainMenuActivity.class));
                        finish();
                        break;
                    }
                }
