...
public class About extends BaseGameActivity {
    ...
    private Font font;
    private Text aboutText, aboutContent, howToPlayText, howToPlayContent;
 ...
 new RatioResolutionPolicy(CAMERA_WIDTH, CAMERA_HEIGHT), camera).setNeedsMusic(true).setNeedsSound(true);
    ...
    public Scene onLoadScene() {
        ...
        aboutText = new Text(CAMERA_WIDTH / 4 - 5, CAMERA_HEIGHT / 4, font, getResources().getString(R.string.about));
        aboutContent = new Text(CAMERA_WIDTH / 4 - 30, CAMERA_HEIGHT / 4 + 20, font, getResources().getString(R.string.about_content));

        howToPlayText = new Text(CAMERA_WIDTH / 4 - 5, CAMERA_HEIGHT / 2 + 25, font, getResources().getString(R.string.how_to_play));
        howToPlayContent = new Text(CAMERA_WIDTH / 4 - 30, CAMERA_HEIGHT / 2 + 40, font, getResources().getString(R.string.how_to_play_content));
        ...
        mainScene.getLastChild().attachChild(aboutText);
        mainScene.getLastChild().attachChild(aboutContent);
        mainScene.getLastChild().attachChild(howToPlayText);
        mainScene.getLastChild().attachChild(howToPlayContent);
        return mainScene;
    }
